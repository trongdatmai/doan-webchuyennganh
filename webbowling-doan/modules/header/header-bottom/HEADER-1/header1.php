...
<!------------ thông báo form marquee chạy xuống------------>
    ...
    <div style="width:600px">
        <a href="#close" title="Close" class="close">X</a>
            ...
            <h3 style="text-align:center">
            	<div style="width:75px;height:80px;border-radius:10px;margin:auto;background:#000;"><img src="background/header/imageinformation.jpg" width="60px" height="80px" style=""></div>
