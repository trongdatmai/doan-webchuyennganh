...
<?php 
	...
	$id_name=$_GET['id'];
					...
					$sql="select * from sanpham where Maloaisp='GA' limit $trang1,9"; // trang1 (vị trí sản phẩm hiện tại) , lấy 5 sản phẩm
...
<div class="sanpham" style="float:left">
 ...
 <?php
                 $sql_sql="SELECT count(*) FROM sanpham where Maloaisp='GA'";
                    ...
                    <ul class="pagination modal-4" >
                      ...
                      <li style="width:600px"><a href="index.php?xem=gangtay&id=GA&trang=<?php echo $b ?>" ><?php echo $b?></a></li>
