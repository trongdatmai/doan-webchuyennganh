...
<div style="float:right;font-size:30px;color:#F00">QUẢN LÝ THÔNG TIN SIZE</div>
TRANG :
<?php
	...
	echo '<br>'.'TỔNG SIZE SẢN PHẨM LÀ: '.$row_1[0];
...
<table width="60%" border="1">
 ...
 <?php foreach($data as $row){?>
  <tr>
    ...
    <td width="11%"><div align="center"><a href="index.php?quanly=quanlysize&ac=sua&id=<?php echo $row['Masp'] ?>&size=<?php echo  $row['size']?>"><div class="glyphicon glyphicon-pencil" style="font-size:40px"></div></a></div></td>
    <td width="11%"><div align="center"><a href="modules/quanlysize/xuly.php?id=<?php echo $row['Masp'];?>&size=<?php echo  $row['size']?>" onclick="return confirm('Bạn có xác nhận xóa size này hay không')"><div class="glyphicon glyphicon-trash" style="font-size:40px"></div></a></div></td>
  </tr>
  <?php }?>
</table>
